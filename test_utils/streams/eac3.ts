 ...
 */
/** Video ID for CBCS encrypted E-AC-3 streams. */
export const CBCS_VIDEO_ID = '6508f99557a8385f';
/** Widevine signature for CBCS encrypted E-AC-3 streams. */
export const CBCS_WIDEVINE_SIGNATURE =
  '5153900DAC410803EC269D252DAAA82BA6D8B825.495E631E406584A8EFCB4E9C9F3D45F6488B94E4';
/** Key identifier for CBCS encrypted E-AC-3 streams. */
export const KEY = 'ik0';

/** E-AC-3 Audio51 Stream (5.1 channel). */
const Audio51: AudioStreamData = [
  'spoken_channel_positions_eac3_51.fmp4',
  645820,
  13.44,
];

/** E-AC-3 DrmCbcs Stream (CBCS encrypted). */
const DrmCbcs: AudioStreamData = [
  'cbcs/spoken_channel_positions_eac3_51.fmp4',
  646818,
  13.44,
  {
...
/** Main collection of all E-AC-3 streams. */
export const EAC3_STREAMS: AudioStreamsType = {
  streamtype: 'EAC3',
